    ...
    <div class="min-h-screen bg-gradient-to-br from-stone-950 via-stone-900 to-stone-950 flex items-center justify-center p-6">
      <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-stone-500 mt-2">Start your growth journey</p>
        </div>
        ...
        <div class="bg-stone-900/70 backdrop-blur border border-stone-800 rounded-2xl p-8">
          ...
          <form (submit)="handleSubmit($event)">
            <div class="mb-4">
              <label class="block text-stone-400 text-sm mb-2">Name</label>
              <input type="text" 
                     [value]="name()"
          ...
          <div class="mt-6 text-center">
            <span class="text-stone-500">Already have an account? </span>
            <a routerLink="/login" class="text-lime-400 hover:text-lime-300 font-medium">Sign in</a>
          </div>
        </div>
